...
int llama_rn_context::applyLoraAdapters(std::vector<common_lora_adapter_info> lora) {
    for (auto &la : lora) {
...
std::vector<common_lora_adapter_info> llama_rn_context::getLoadedLoraAdapters() {
    return this->lora;
}
