...
std::pair<lm_ggml_tensor *, lm_ggml_tensor *> llm_build_qwen35::build_delta_net_chunking(
        lm_ggml_tensor * q,
        lm_ggml_tensor * k,
        lm_ggml_tensor * v,
        lm_ggml_tensor * g,
...
std::pair<lm_ggml_tensor *, lm_ggml_tensor *> llm_build_qwen35::build_delta_net_autoregressive(
        lm_ggml_tensor * q,
        lm_ggml_tensor * k,
        lm_ggml_tensor * v,
        lm_ggml_tensor * g,
...
std::pair<lm_ggml_tensor *, lm_ggml_tensor *> llm_build_qwen35::build_qkvz(
...
lm_ggml_tensor * llm_build_qwen35::build_norm_gated(
        lm_ggml_tensor * input,
...
lm_ggml_tensor * llm_build_qwen35::build_layer_attn(
...
lm_ggml_tensor * llm_build_qwen35::build_layer_attn_linear(
...
lm_ggml_tensor * llm_build_qwen35::build_layer_ffn(lm_ggml_tensor * cur, const int il) {
