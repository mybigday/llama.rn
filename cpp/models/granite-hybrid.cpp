...
lm_ggml_tensor * llama_model_granite_hybrid::graph::build_attention_layer(lm_ggml_tensor *             cur,
...
lm_ggml_tensor * llama_model_granite_hybrid::graph::build_layer_ffn(lm_ggml_tensor *       cur,
