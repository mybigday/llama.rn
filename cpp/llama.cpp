    ...
    struct lm_ggml_cgraph * build_llama() {
        ...
        for (int il = 0; il < n_layer; ++il) {
            ...
            // self-attention
            {
                ...
                Qcur = lm_ggml_rope_custom(ctx0, lm_ggml_reshape_3d(ctx0, Qcur, n_embd_head, n_head,    n_tokens), inp_pos, n_embd_head, 0, 0, freq_base, freq_scale);
                cb(Qcur, "Qcur", il);

                Kcur = lm_ggml_rope_custom(ctx0, lm_ggml_reshape_3d(ctx0, Kcur, n_embd_head, n_head_kv, n_tokens), inp_pos, n_embd_head, 0, 0, freq_base, freq_scale);
                cb(Kcur, "Kcur", il);
    ...
    struct lm_ggml_cgraph * build_falcon() {
        ...
        for (int il = 0; il < n_layer; ++il) {
            ...
            // self-attention
            {
                ...
                Qcur = lm_ggml_rope_custom(ctx0, Qcur, inp_pos, n_embd_head, 2, 0, freq_base, freq_scale);
                cb(Qcur, "Qcur", il);

                Kcur = lm_ggml_rope_custom(ctx0, Kcur, inp_pos, n_embd_head, 2, 0, freq_base, freq_scale);
                cb(Kcur, "Kcur", il);
