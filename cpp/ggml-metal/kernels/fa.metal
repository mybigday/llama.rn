...
kernel void kernel_flash_attn_ext_kv_f16(
        constant lm_ggml_metal_kargs_flash_attn_ext_kv_f16 & args,
        device const char * x,
        device       half * x_dst,
...
kernel void kernel_flash_attn_ext_vec_idx(
        constant lm_ggml_metal_kargs_flash_attn_ext_vec_idx & args,
...
kernel void kernel_lightning_indexer(
        constant lm_ggml_metal_kargs_lightning_indexer & args,
        device const char * q,
        device const char * k,
        device const char * w,
        device const char * m,
