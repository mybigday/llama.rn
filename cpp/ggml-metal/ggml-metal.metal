...
#define QK2_0 64
typedef struct {
    lm_ggml_half d;              // delta (scale)
    uint8_t qs[QK2_0 / 4];   // 2 bits per element
} block_q2_0;
static_assert(sizeof(block_q2_0) == sizeof(lm_ggml_half) + QK2_0 / 4, "wrong q2_0 block size/padding");
...
LM_GGML_TABLE_BEGIN(int8_t, kvalues_fp4, 16)
