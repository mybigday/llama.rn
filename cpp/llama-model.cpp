...
struct llm_build_mamba : public llm_graph_context {
    llm_build_mamba(const llama_model & model, const llm_graph_params & params, lm_ggml_cgraph * gf) : llm_graph_context(params) {
        lm_ggml_tensor * cur;
        lm_ggml_tensor * inpL;
    ...
    lm_ggml_tensor * build_mamba_layer(
        ...
        // ssm
        {
            ...
            y = lm_ggml_add(ctx0, y, lm_ggml_mul(ctx0, cur, model.layers[il].ssm_d));
