...
void quantize_row_q2_0_ref(const float * LM_GGML_RESTRICT x, block_q2_0 * LM_GGML_RESTRICT y, int64_t k) {
...
void dequantize_row_q2_0(const block_q2_0 * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k) {
    static const int qk = QK2_0;
...
size_t quantize_q2_0(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrow, int64_t n_per_row, const float * quant_weights) {
    if (!quant_weights) {
        quantize_row_q2_0_ref(src, dst, (int64_t)nrow*n_per_row);
        return nrow * lm_ggml_row_size(LM_GGML_TYPE_Q2_0, n_per_row);
    }
    size_t row_size = lm_ggml_row_size(LM_GGML_TYPE_Q2_0, n_per_row);
    char * qrow = (char *)dst;
    for (int64_t row = 0; row < nrow; ++row) {
