        ...
        for (int b = 0; b < nb; b++) {
            ...
            for (int half = 0; half < 2; half++) {
                ...
                for (int sb = 0; sb < QK_K / 64; sb++) {
                    ...
                    lm_ggml_uint8x16x4_t q6_ql_0 = lm_ggml_vld1q_u8_x4(ql_base + ql_off_base);
                    lm_ggml_uint8x16x4_t q6_ql_1 = lm_ggml_vld1q_u8_x4(ql_base + ql_off_base + 64);
                    lm_ggml_uint8x16x4_t q6_qh_0 = lm_ggml_vld1q_u8_x4(qh_base + qh_off_base);
                    lm_ggml_uint8x16x4_t q6_qh_1 = lm_ggml_vld1q_u8_x4(qh_base + qh_off_base + 64);
