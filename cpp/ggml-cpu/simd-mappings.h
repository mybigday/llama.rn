...
// defined in ggml-cpu.c, initialized in lm_ggml_cpu_init()
extern float lm_ggml_table_f32_ue4m3[1 << 8];
...
#define LM_GGML_CPU_UE4M3_TO_FP32(x) lm_ggml_table_f32_ue4m3[(uint8_t)(x)]
#else
#define LM_GGML_CPU_UE4M3_TO_FP32(x) lm_ggml_ue4m3_to_fp32(x)
#endif
...
#define LM_GGML_F32Cx8_SET1(x) (__m256)__lasx_xvreplfr2vr_s((x))
...
#define LM_GGML_F32x4_SET1(x) (__m128)__lsx_vreplfr2vr_s((x))
...
static inline void __lsx_f16x4_store(lm_ggml_fp16_t * x, __m128 y) {
    ...
    memcpy(x, &a, sizeof(lm_ggml_fp16_t) * 4);
}

#define LM_GGML_F32Cx4             __m128
#define LM_GGML_F32Cx4_ZERO        (__m128)__lsx_vldi(0)
#define LM_GGML_F32Cx4_SET1(x)     (__m128)__lsx_vreplfr2vr_s((x))
