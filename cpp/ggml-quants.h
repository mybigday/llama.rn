...
static_assert(sizeof(block_iq3_xxs) == sizeof(lm_ggml_fp16_t) + 3*(QK_K/8), "wrong iq3_xxs block size/padding");
...
static_assert(sizeof(block_iq1_s) == sizeof(lm_ggml_fp16_t) + QK_K/8 + QK_K/16, "wrong iq1_s block size/padding");
...
static_assert(sizeof(block_iq4_nl) == sizeof(lm_ggml_fp16_t) + QK4_NL/2, "wrong iq4_nl block size/padding");
