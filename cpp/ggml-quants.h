...
LM_GGML_API void quantize_row_q2_0_ref(const float * LM_GGML_RESTRICT x, block_q2_0 * LM_GGML_RESTRICT y, int64_t k);
...
LM_GGML_API void dequantize_row_q2_0(const block_q2_0 * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k);
...
LM_GGML_API size_t quantize_q2_0(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
